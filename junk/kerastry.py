...
toolbox.register("evaluate", functions.test_weights, X=X_train, y=y_train, neurons_in_hidden=neurons_in_hidden, inputs=num_inputs, outputs=num_outputs)
...
if __name__ == "__main__":
    ...
    print("Test finale:")
    fitness = functions.test_weights(best, X=X_test, y=y_test, 
